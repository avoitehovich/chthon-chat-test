...
CREATE TABLE IF NOT EXISTS public.analytics (
  ...
  user_id UUID REFERENCES public.users(id) ON DELETE SET NULL,  -- Changed from TEXT to UUID
...
CREATE TABLE IF NOT EXISTS public.chat_sessions (
  id TEXT PRIMARY KEY,
  user_id UUID NOT NULL REFERENCES public.users(id) ON DELETE CASCADE,  -- Changed from TEXT to UUID
  name TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.admin_settings (
  ...
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
  updated_by UUID REFERENCES public.users(id) ON DELETE SET NULL  -- Changed from TEXT to UUID
);
